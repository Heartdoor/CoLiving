...
public partial class BuildingController : Node
{
    ...
    void SetupBuildings()
    {
        AddNewBuilding(0, ColorGrey);
        var firstflat = AddNewBuilding(1, ColorBlue,
            new RoomItem(1, RoomType.none),
            new RoomItem(2, RoomType.none),
            new RoomItem(3, RoomType.none),
            new RoomItem(4, RoomType.none),
            new RoomItem(4, RoomType.none));
