...
public class TargetWrapper
{
    ...
    public FurnitureName? FurnitureTarget { get; private set; }

    public bool IsCharacter => CharacterTarget != null;
    public bool IsObjectType => FurnitureTarget != null;

    // Constructor for a Character target
    public TargetWrapper(CharacterController character)
    {
        CharacterTarget = character;
    }

    // Constructor for an ObjectType target
    public TargetWrapper(FurnitureName objectType)
    {
        FurnitureTarget = objectType;
    }
}
